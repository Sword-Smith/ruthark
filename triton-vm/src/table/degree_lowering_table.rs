...
pub enum DegreeLoweringBaseTableColumn {
    ...
    DegreeLoweringBaseCol212,
    DegreeLoweringBaseCol213,
    DegreeLoweringBaseCol214,
    DegreeLoweringBaseCol215,
    DegreeLoweringBaseCol216,
    DegreeLoweringBaseCol217,
    DegreeLoweringBaseCol218,
    DegreeLoweringBaseCol219,
    DegreeLoweringBaseCol220,
    DegreeLoweringBaseCol221,
    DegreeLoweringBaseCol222,
    DegreeLoweringBaseCol223,
    DegreeLoweringBaseCol224,
    DegreeLoweringBaseCol225,
}
#[repr(usize)]
#[derive(Debug, Display, Copy, Clone, Eq, PartialEq, Hash, EnumCount, EnumIter)]
pub enum DegreeLoweringExtTableColumn {
    ...
    DegreeLoweringExtCol36,
    DegreeLoweringExtCol37,
}
...
impl DegreeLoweringTable {
    ...
    pub fn fill_derived_base_columns(
        ...
        Zip::from(current_section.slice_mut(s![0..num_rows - 1, ..]).rows_mut())
            ...
            .par_for_each(|mut section_row, &current_row_index| {
                ...
                section_row[1usize] = (current_base_row[169usize])
                ...
                section_row[3usize] = ((current_base_row[12usize])
                    * ((current_base_row[13usize])
                        + (BFieldElement::from_raw_u64(18446744065119617026u64))))
                    * ((current_base_row[14usize])
                        + (BFieldElement::from_raw_u64(18446744065119617026u64)));
                ...
                section_row[12usize] = (current_base_row[175usize])
                    * ((BFieldElement::from_raw_u64(4294967295u64))
                        + ((BFieldElement::from_raw_u64(18446744065119617026u64))
                            * (current_base_row[40usize])));
                ...
                section_row[48usize] = (current_base_row[185usize])
                    * (current_base_row[15usize]);
                current_base_row.push(Axis(0), section_row.slice(s![48usize])).unwrap();
                section_row[49usize] = ((current_base_row[187usize])
                    * (current_base_row[17usize]))
                    * ((current_base_row[18usize])
                        + (BFieldElement::from_raw_u64(18446744065119617026u64)));
                current_base_row.push(Axis(0), section_row.slice(s![49usize])).unwrap();
                section_row[50usize] = (((current_base_row[184usize])
                    * (current_base_row[15usize]))
                    * ((current_base_row[16usize])
                        + (BFieldElement::from_raw_u64(18446744065119617026u64))))
                    * ((current_base_row[17usize])
                ...
                section_row[82usize] = (((current_base_row[97usize])
                ...
                section_row[83usize] = (current_base_row[227usize])
                    * ((current_base_row[16usize])
                        + (BFieldElement::from_raw_u64(18446744065119617026u64)));
                current_base_row.push(Axis(0), section_row.slice(s![83usize])).unwrap();
                section_row[84usize] = (((current_base_row[98usize])
                ...
                section_row[85usize] = (current_base_row[42usize])
                    * ((current_base_row[42usize])
                        + (BFieldElement::from_raw_u64(18446744065119617026u64)));
                current_base_row.push(Axis(0), section_row.slice(s![85usize])).unwrap();
                section_row[86usize] = (((current_base_row[99usize])
                ...
                section_row[87usize] = (((current_base_row[100usize])
                ...
                section_row[88usize] = ((current_base_row[201usize])
                    * (current_base_row[17usize]))
                    * ((current_base_row[18usize])
                        + (BFieldElement::from_raw_u64(18446744065119617026u64)));
                current_base_row.push(Axis(0), section_row.slice(s![88usize])).unwrap();
                section_row[89usize] = ((current_base_row[188usize])
                    * (current_base_row[17usize]))
                    * ((current_base_row[18usize])
                        + (BFieldElement::from_raw_u64(18446744065119617026u64)));
                current_base_row.push(Axis(0), section_row.slice(s![89usize])).unwrap();
                section_row[90usize] = (((current_base_row[101usize])
                ...
                section_row[96usize] = (current_base_row[239usize])
                    * ((current_base_row[18usize])
                        + (BFieldElement::from_raw_u64(18446744065119617026u64)));
                current_base_row.push(Axis(0), section_row.slice(s![96usize])).unwrap();
                section_row[97usize] = (((current_base_row[215usize])
                    * (current_base_row[16usize]))
                    * ((current_base_row[17usize])
                        + (BFieldElement::from_raw_u64(18446744065119617026u64))))
                    * ((current_base_row[18usize])
                ...
                section_row[98usize] = (((current_base_row[103usize])
                ...
                section_row[104usize] = (((current_base_row[227usize])
                    * (current_base_row[16usize]))
                    * ((current_base_row[17usize])
                        + (BFieldElement::from_raw_u64(18446744065119617026u64))))
                    * ((current_base_row[18usize])
                ...
                section_row[105usize] = (((current_base_row[105usize])
                ...
                section_row[106usize] = ((current_base_row[209usize])
                    * (current_base_row[17usize]))
                    * ((current_base_row[18usize])
                        + (BFieldElement::from_raw_u64(18446744065119617026u64)));
                current_base_row.push(Axis(0), section_row.slice(s![106usize])).unwrap();
                section_row[107usize] = (((current_base_row[204usize])
                    * (current_base_row[16usize]))
                    * ((current_base_row[17usize])
                        + (BFieldElement::from_raw_u64(18446744065119617026u64))))
                    * ((current_base_row[18usize])
                ...
                section_row[108usize] = (((current_base_row[106usize])
                ...
                section_row[109usize] = (((current_base_row[107usize])
                ...
                section_row[110usize] = (current_base_row[39usize])
                    * (current_base_row[22usize]);
                current_base_row.push(Axis(0), section_row.slice(s![110usize])).unwrap();
                section_row[111usize] = (((current_base_row[108usize])
                ...
                section_row[131usize] = (current_base_row[239usize])
                    * (current_base_row[18usize]);
                current_base_row.push(Axis(0), section_row.slice(s![131usize])).unwrap();
                section_row[132usize] = (current_base_row[231usize])
                    * (current_base_row[18usize]);
                current_base_row.push(Axis(0), section_row.slice(s![132usize])).unwrap();
                section_row[133usize] = ((((next_base_row[142usize])
                    + (BFieldElement::from_raw_u64(18446744052234715141u64)))
                ...
                section_row[134usize] = (current_base_row[40usize])
                    * ((current_base_row[40usize])
                        + (BFieldElement::from_raw_u64(18446744065119617026u64)));
                current_base_row.push(Axis(0), section_row.slice(s![134usize])).unwrap();
                section_row[135usize] = ((next_base_row[142usize])
                    + (BFieldElement::from_raw_u64(18446744052234715141u64)))
                    * ((next_base_row[142usize])
                        + (BFieldElement::from_raw_u64(18446744043644780551u64)));
                current_base_row.push(Axis(0), section_row.slice(s![135usize])).unwrap();
                section_row[136usize] = ((((next_base_row[64usize])
                    + (BFieldElement::from_raw_u64(18446744065119617026u64)))
                    * ((next_base_row[64usize])
                        + (BFieldElement::from_raw_u64(18446744060824649731u64))))
                    * ((next_base_row[64usize])
                ...
                section_row[162usize] = ((next_base_row[139usize])
                    + (BFieldElement::from_raw_u64(18446744065119617026u64)))
                ...
                section_row[168usize] = (next_base_row[44usize])
                    * (next_base_row[41usize]);
                ...
                section_row[170usize] = (next_base_row[44usize])
                    * (next_base_row[42usize]);
                ...
                section_row[172usize] = (next_base_row[44usize])
                    * (next_base_row[43usize]);
                ...
                section_row[174usize] = (next_base_row[44usize])
                ...
                section_row[176usize] = (next_base_row[44usize])
                ...
                section_row[178usize] = (next_base_row[44usize])
                    * (next_base_row[24usize]);
                ...
                section_row[180usize] = (next_base_row[44usize])
                ...
                section_row[182usize] = (next_base_row[44usize])
                    * (next_base_row[26usize]);
                current_base_row.push(Axis(0), section_row.slice(s![182usize])).unwrap();
                section_row[183usize] = (((current_base_row[325usize])
                ...
                section_row[184usize] = (((current_base_row[321usize])
                    * ((next_base_row[15usize])
                        + (BFieldElement::from_raw_u64(18446744065119617026u64))))
                    * ((next_base_row[16usize])
                        + (BFieldElement::from_raw_u64(18446744065119617026u64))))
                ...
                section_row[185usize] = (current_base_row[39usize])
                    * (current_base_row[42usize]);
                current_base_row.push(Axis(0), section_row.slice(s![185usize])).unwrap();
                section_row[186usize] = (((current_base_row[321usize])
                    * (next_base_row[15usize]))
                    * ((next_base_row[16usize])
                        + (BFieldElement::from_raw_u64(18446744065119617026u64))))
                    * (next_base_row[17usize]);
                current_base_row.push(Axis(0), section_row.slice(s![186usize])).unwrap();
                section_row[187usize] = (current_base_row[320usize])
                    * ((((next_base_row[62usize])
                        + (BFieldElement::from_raw_u64(18446744060824649731u64)))
                        * ((next_base_row[62usize])
                            + (BFieldElement::from_raw_u64(18446744056529682436u64))))
                ...
                section_row[188usize] = (((current_base_row[62usize])
                    + (BFieldElement::from_raw_u64(18446744060824649731u64)))
                    * ((current_base_row[62usize])
                        + (BFieldElement::from_raw_u64(18446744056529682436u64))))
                    * (current_base_row[62usize]);
                current_base_row.push(Axis(0), section_row.slice(s![188usize])).unwrap();
                section_row[189usize] = (current_base_row[237usize])
                    * ((next_base_row[22usize])
                        * (((current_base_row[39usize])
                            * ((next_base_row[23usize])
                ...
                section_row[190usize] = (current_base_row[213usize])
                ...
                section_row[191usize] = (current_base_row[213usize])
                ...
                section_row[192usize] = (current_base_row[213usize])
                    * (((current_base_row[254usize])
                        * ((current_base_row[42usize])
                            + (BFieldElement::from_raw_u64(18446744060824649731u64))))
                        * ((current_base_row[42usize])
                            + (BFieldElement::from_raw_u64(18446744056529682436u64))));
                current_base_row.push(Axis(0), section_row.slice(s![192usize])).unwrap();
                section_row[193usize] = (current_base_row[213usize])
                    * (((current_base_row[295usize])
                        * ((current_base_row[44usize])
                            + (BFieldElement::from_raw_u64(18446744060824649731u64))))
                        * ((current_base_row[44usize])
                            + (BFieldElement::from_raw_u64(18446744056529682436u64))));
                current_base_row.push(Axis(0), section_row.slice(s![193usize])).unwrap();
                section_row[194usize] = (((current_base_row[64usize])
                    ...
                    * ((current_base_row[64usize])
                        + (BFieldElement::from_raw_u64(18446744056529682436u64)));
                current_base_row.push(Axis(0), section_row.slice(s![194usize])).unwrap();
                section_row[195usize] = ((((current_base_row[62usize])
                    + (BFieldElement::from_raw_u64(18446744065119617026u64)))
                    * ((current_base_row[62usize])
                        + (BFieldElement::from_raw_u64(18446744056529682436u64))))
                    * (current_base_row[62usize]))
                    * ((next_base_row[62usize])
                        + (BFieldElement::from_raw_u64(18446744060824649731u64)));
                current_base_row.push(Axis(0), section_row.slice(s![195usize])).unwrap();
                section_row[196usize] = (((current_base_row[304usize])
                    * ((next_base_row[142usize])
                        + (BFieldElement::from_raw_u64(18446744017874976781u64))))
                    * ((next_base_row[142usize])
                        + (BFieldElement::from_raw_u64(18446743940565565471u64))))
                    * ((next_base_row[142usize])
                        + (BFieldElement::from_raw_u64(18446743949155500061u64)));
                current_base_row.push(Axis(0), section_row.slice(s![196usize])).unwrap();
                section_row[197usize] = (current_base_row[324usize])
                    * ((((BFieldElement::from_raw_u64(4294967295u64))
                        + ((BFieldElement::from_raw_u64(18446744065119617026u64))
                        ...
                        + (((BFieldElement::from_raw_u64(8589934590u64))
                            ...
                            * ((current_base_row[145usize])
                                + ((BFieldElement::from_raw_u64(18446744065119617026u64))
                                    * ((BFieldElement::from_raw_u64(8589934590u64))
                                        * (next_base_row[145usize]))))));
                current_base_row.push(Axis(0), section_row.slice(s![197usize])).unwrap();
                section_row[198usize] = ((next_base_row[139usize])
                    + (BFieldElement::from_raw_u64(18446744065119617026u64)))
                    * ((current_base_row[329usize])
                        * ((next_base_row[142usize])
                            + (BFieldElement::from_raw_u64(18446743949155500061u64))));
                current_base_row.push(Axis(0), section_row.slice(s![198usize])).unwrap();
                section_row[199usize] = (((((next_base_row[59usize])
                    + ((BFieldElement::from_raw_u64(18446744065119617026u64))
                    ...
                    * (((next_base_row[57usize])
                        ...
                        + (BFieldElement::from_raw_u64(18446744065119617026u64)));
                current_base_row.push(Axis(0), section_row.slice(s![199usize])).unwrap();
                section_row[200usize] = (current_base_row[357usize])
                    * ((((next_base_row[62usize])
                        + (BFieldElement::from_raw_u64(18446744065119617026u64)))
                        * ((next_base_row[62usize])
                            + (BFieldElement::from_raw_u64(18446744056529682436u64))))
                        * (next_base_row[62usize]));
                current_base_row.push(Axis(0), section_row.slice(s![200usize])).unwrap();
                section_row[201usize] = ((((current_base_row[62usize])
                    + (BFieldElement::from_raw_u64(18446744065119617026u64)))
                    * ((current_base_row[62usize])
                        + (BFieldElement::from_raw_u64(18446744060824649731u64))))
                    * (current_base_row[62usize]))
                    * ((next_base_row[62usize])
                        + (BFieldElement::from_raw_u64(18446744056529682436u64)));
                current_base_row.push(Axis(0), section_row.slice(s![201usize])).unwrap();
                section_row[202usize] = (((current_base_row[320usize])
                    * ((next_base_row[62usize])
                        + (BFieldElement::from_raw_u64(18446744056529682436u64))))
                    * (next_base_row[62usize]))
                    * ((next_base_row[63usize])
                        + (BFieldElement::from_raw_u64(18446743897615892521u64)));
                current_base_row.push(Axis(0), section_row.slice(s![202usize])).unwrap();
                section_row[203usize] = (current_base_row[320usize])
                    * ((((next_base_row[63usize])
                        ...
                        * ((next_base_row[63usize])
                            + (BFieldElement::from_raw_u64(18446743923385696291u64))));
                current_base_row.push(Axis(0), section_row.slice(s![203usize])).unwrap();
                section_row[204usize] = ((current_base_row[331usize])
                    * ((BFieldElement::from_raw_u64(4294967295u64))
                        + ((BFieldElement::from_raw_u64(18446744065119617026u64))
                            * ((next_base_row[143usize]) * (next_base_row[144usize])))))
                    * (current_base_row[143usize]);
                current_base_row.push(Axis(0), section_row.slice(s![204usize])).unwrap();
                section_row[205usize] = ((next_base_row[147usize])
                    * (next_base_row[147usize])) * (current_base_row[143usize]);
                current_base_row.push(Axis(0), section_row.slice(s![205usize])).unwrap();
            });
    }
    #[allow(unused_variables)]
    #[allow(unused_mut)]
    pub fn fill_derived_ext_columns(
        ...
        let (original_part, mut current_section) = master_ext_table
            .multi_slice_mut((s![.., 0..50usize], s![.., 50usize..50usize + 38usize]));
        let row_indices = Array1::from_vec((0..num_rows - 1).collect::<Vec<_>>());
        Zip::from(current_section.slice_mut(s![0..num_rows - 1, ..]).rows_mut())
            .and(row_indices.view())
            .par_for_each(|mut section_row, &current_row_index| {
                ...
                section_row[15usize] = (((current_ext_row[56usize])
                    * ((challenges[7usize])
                        + ((BFieldElement::from_raw_u64(18446744065119617026u64))
                            * (((((challenges[16usize]) * (current_base_row[7usize]))
                                + ((challenges[17usize]) * (current_base_row[13usize])))
                ...
                section_row[16usize] = (((current_ext_row[60usize])
                    * ((challenges[7usize])
                        + ((BFieldElement::from_raw_u64(18446744065119617026u64))
                            * (((((challenges[16usize]) * (current_base_row[7usize]))
                                + ((challenges[17usize]) * (current_base_row[13usize])))
                ...
                section_row[17usize] = (current_ext_row[6usize])
                ...
                section_row[18usize] = (current_ext_row[6usize])
                ...
                section_row[19usize] = (current_base_row[199usize])
                    * ((next_ext_row[7usize])
                        + ((BFieldElement::from_raw_u64(18446744065119617026u64))
                ...
                section_row[20usize] = (current_base_row[199usize])
                    * ((next_ext_row[7usize])
                        + ((BFieldElement::from_raw_u64(18446744065119617026u64))
                            * ((current_ext_row[7usize])
                ...
                section_row[24usize] = (current_base_row[195usize])
                    * ((next_ext_row[6usize])
                        + ((BFieldElement::from_raw_u64(18446744065119617026u64))
                ...
                section_row[34usize] = ((((next_ext_row[21usize])
                    + ((BFieldElement::from_raw_u64(18446744065119617026u64))
                ...
                section_row[35usize] = (current_base_row[297usize])
                    * (((current_ext_row[7usize])
                ...
                section_row[36usize] = (current_base_row[218usize])
                ...
                current_ext_row.push(Axis(0), section_row.slice(s![36usize])).unwrap();
                section_row[37usize] = (current_base_row[224usize])
                    * ((((((current_base_row[195usize])
                        * ((next_ext_row[7usize])
                            + ((BFieldElement::from_raw_u64(18446744065119617026u64))
                                * ((current_ext_row[7usize])
                ...
                current_ext_row.push(Axis(0), section_row.slice(s![37usize])).unwrap();
            });
    }
}
