...
def canonicalize (n: u64) : BFieldElement = n % prime
def newmod (n: i32): BFieldElement = (u64.i32 n) % prime
def addmod (a: BFieldElement) (b: BFieldElement): BFieldElement = (a + b) % prime
def remmod (a: BFieldElement) (b: BFieldElement): BFieldElement = (a % b) % prime
